...
from processing_functions import rename_coord_titles_to_lat_long, regrid_to_5km_grid, constrain_to_australia
...
def process_runoff():
    ...
    runoff = rename_coord_titles_to_lat_long(runoff)
    regridded_runoff = regrid_to_5km_grid(runoff)
